...
def program_intro(name):
    ...
    time.sleep(0.1)
    print(f'Hello {bold(magenta(name))}, I\'m {bold(bright_green('Teki'))}. And welcome to {bold(red('Teki\'s Python Learning Program.'))}')
    time.sleep(0.1)
    print(f"\nThis program is designed to help you learn {bold(green('Python'))} step by step.")
    time.sleep(0.1)
    ...
    time.sleep(0.1)
    print(f"Press {bright_green('0')} at any menu to go back or exit.")
    time.sleep(0.1)
    print(yellow("\nLet's get started!\n"))
    time.sleep(0.1)
